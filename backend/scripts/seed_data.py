...
posts = [
    ...
    {"Post_Id": "POST#001", "Post_Element_Type": "IMAGE", "Value": "{ \"url\": \"/users/Moe/FeelsTheCat.jpg\", \"alttext\": \"Feels The Cat\" }"},
    ...
    {"Post_Id": "POST#002", "Post_Element_Type": "IMAGE", "Value": "{ \"url\": \"/users/Moe/PythonLogo.png\", \"alttext\": \"Official Python Logo\" }"},
